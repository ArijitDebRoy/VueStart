    ...
    <form id="entry">
                ...
                <div class="row" style="margin-top:4.5vh">
                    <div class="col-lg-4 col-lg-offset-1">
                        <div class="input-group">
                            ...
                            <input v-model="response.t_name" class="form-control" type="text" name="t_name" id="t_name" placeholder="Train Name"  />
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-minus-square fa-fw"></i></span>
                            <input v-model="response.t_no" class="form-control" type="text" name="t_no" id="t_no" placeholder="Train Number" />
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="input-group">
                            <select v-model="response.type" name="type" class="selectpicker show-tick" id="type" title="---Select type of train---">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        <div class="form-group">
                            <textarea v-model="response.description" class="form-control" name="desc" id="desc" placeholder="Description of the Train" rows="5" ></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row" style="margin-top:5vh">
                    <div class="col-lg-4 col-lg-offset-1">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-train  fa-fw"></i></span>
                            <input v-model="response.src" class="form-control" type="text" name="src" id="src" placeholder="Source Station" />
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-calendar fa-fw"></i></span>
                            <input v-model="response.sdate" class="form-control" type="text" name="sdate" id="sdate" placeholder="Strat Date" data-provide="datetimepicker"/>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-calendar fa-fw"></i></span>
                            <input v-model="response.stime" class="form-control" type="text" name="stime" id="stime" placeholder="Strat Time" data-provide="datetimepicker"/>
                        </div>
                    </div>
        ...
        <section id="third" style="display:none" class="tabcontent">
            ...
            <div class="container" >
                ...
                <div class="row" style="margin-top:5vh" id="inp_wrap" v-for="route in response.routes">
                    <div class="col-lg-4 col-lg-offset-1">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-train  fa-fw"></i></span>
            ...
            <center>
                <button id="t3btn" class="btn btn-default" style="background-color:#399cf9; color:white;margin-left:-20px;margin-top:10.5vh" type="button" @click="saveDate()">Submit</button>
            </center>
...
<script>
    export default {
        ...
        methods: {
            ...
            saveDate: function () {
                $.get('data/save',this.response).then(function (response) {

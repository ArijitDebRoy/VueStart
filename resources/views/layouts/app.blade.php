...
<div id="drawerExample" class="drawer dw-xs-10 dw-sm-6 dw-md-3 fold" aria-labelledby="drawerExample">
    ...
    <div class="drawer-contents">
        ...
        <hr/>
        <ul class="drawer-nav">
            <li role="presentation"><a href="{{url('/home#!/')}}" style="color: black">Add Train</a></li>
            {{--<li role="presentation"><a href="#" style="color: black">Update Train</a></li>--}}
            <li role="presentation"><a href="{{url('/home#!/show')}}" style="color: black">Show Trains</a></li>
        </ul>
        <hr/>
...
<script>
    $(document).ready(function(){
        $('body').on('focus',".atime", function(){
            $(this).datetimepicker({
                useCurrent: false, //Important! See issue #1075
                format: 'hh:mm:ss A'
            });
        })
            $('body').on('focus',".dtime", function(){
                $(this).datetimepicker({
                    useCurrent: false, //Important! See issue #1075
                    format: 'hh:mm:ss A'
                });
